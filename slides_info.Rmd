...
covid = read.csv("/Users/marin_li/Desktop/data3888\ project/covid_p11-main/owid-covid-data.csv")
sp500 = read.csv("/Users/marin_li/Desktop/data3888\ project/covid_p11-main/SPY Historical Data.csv", fileEncoding = 'UTF-8-BOM')
TOPIX = read.csv("/Users/marin_li/Desktop/data3888\ project/covid_p11-main/TOPIX Historical Data.csv", fileEncoding = 'UTF-8-BOM')
ASX200 = read.csv("/Users/marin_li/Desktop/data3888\ project/covid_p11-main/S&P_ASX 200 Historical Data.csv", fileEncoding = 'UTF-8-BOM')
NSEI = read.csv("/Users/marin_li/Desktop/data3888\ project/covid_p11-main/Nifty 50 Historical Data.csv", fileEncoding = 'UTF-8-BOM') 
SSEC = read.csv("/Users/marin_li/Desktop/data3888\ project/covid_p11-main/Shanghai Composite Historical Data.csv", fileEncoding = 'UTF-8-BOM') 
covid2 <- covid
