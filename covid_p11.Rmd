...
```{r}
#Dropping NA
covid_clean = covid %>% drop_na(new_cases, new_cases_smoothed, new_vaccinations, new_vaccinations_smoothed, new_vaccinations_smoothed_per_million, population, median_age, extreme_poverty, total_vaccinations, hospital_beds_per_thousand, human_development_index, new_deaths, new_tests)
...
covid2 <- covid2 %>%
  ...
  select(date, new_cases, new_deaths, location, new_vaccinations, new_tests)
