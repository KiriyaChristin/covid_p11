...
Analysis: From the above barplot, we set different months of 2021 and 2022 as y-axis and the number of smoothed new cases as x-axis. We can easily know that smoothed new cases in most month is less than 30,000,000 except in Jan, 2022. So the data of new_cases_smoothed is evenly distributed and has a small standard deviation.
