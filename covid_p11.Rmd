...
## First visualisation - visualising distribution of gains and losses amoung different years
...
plot(chn_beta_price_case, col = "red")
plot(aus_beta_price_case, col = "light blue")
plot(ind_beta_price_case, col = "light green")
plot(usa_beta_price_case, col = "yellow")
```
```
