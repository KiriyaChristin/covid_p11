...
```{r}
ggplot(data = df_3, mapping = aes(x = Price, y = new_cases)) + geom_point() + ggtitle("Prices of stocks and against new cases (Smoothed)") + ylab("New cases") + xlab("Price")
```
```{r}
...
```{r}
ggplot(data = df_3, mapping = aes(x = Price, y = new_vaccinations)) + geom_point() + ggtitle("Prices of stocks and against new vaccinations (Smoothed)") + ylab("New vaccinations") + xlab("Price")
```
